...
RSpec.describe User, type: :model do
  ...
  subject {
    described_class.new(email: "TEST@TEST.com", first_name: "JOE", last_name: "SHMO", password: "12345", password_confirmation: "12345")
  }
  ...
  describe 'Validations' do
    ...
    it "is invalid when email already exists in the database (not case sensitive)" do
      subject.save!
      @user = User.new(email: "test@test.COM", first_name: "JOE", last_name: "SHMO", password: "12345", password_confirmation: "1234")
  ...
  describe ".authenticate_with_credentials" do
    ...
    it "should be invalid if password doesn't match" do
      user = User.authenticate_with_credentials(subject.email, "8957452")
      expect(user).not_to be_instance_of(User)
    end

    it "should be invalid if email doesn't match" do
      user = User.authenticate_with_credentials("hello@yahoo.com", subject.password)
       expect(user).not_to be_instance_of(User)
    end
